			...
			<div class="row">
							...
							<div class="col-12">
								<div class="row" style="padding: 0.5em 1em;">
									...
									<div class="col-2" style="">
										<div style="display: flex; align-items: flex-start;border: 2px solid #dc3545; padding: 0px; justify-content: flex-start; border-radius: 0.4em;">
											<div class="badge badge-danger" style="color: black; color: white; width: 25%;"> - </div>
											<div style="width: 50%;" class="badge">2</div>
											<div class="badge badge-danger" style="color: black; color: white; width: 25%;"> + </div>
										</div>
									</div>
									<div class="col-3">
										Rp. 46.000 <span class="close">&#10005;</span>
									</div>
								</div>
							</div>
							@endfor
				...
				<div class="col-4">
					<div class="card shadow p-3 mb-5 bg-white rounded">
						<label for="">Metode Pengantaran</label>
						<div class="template-demo" style="display: flex; flex-direction: ">
							<button type="button" class="btn btn-outline-secondary btn-sm" style="margin-right: 1em;">Diantarkan</button>
							<button type="button" class="btn btn-outline-danger btn-sm">Ambil Sendiri</button>
						</div>
						<br>
						<label for="">Metode Pembayaran</label>
						<div class="template-demo" style="display: flex; flex-direction: ">
							<button type="button" class="btn btn-outline-secondary btn-sm" style="margin-right: 1em;">Transfer</button>
							<button type="button" class="btn btn-outline-danger btn-sm">COD</button>
						</div>
						<hr>
						<div style="padding-left: 20px;">
							<div class="row">
								<div class="col" style="padding-left:0;">Total Belanja</div>
								<div class="col text-end">Rp.34.000</div>
							</div>
						</div>

						<button type="button" class="btn btn-danger" style="width: 100%; margin-top: 40px;" onclick="modal_pesan()">Bayar</button>
