  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index3.html" class="brand-link">
        <img src="<?=url('/')?>/public/assets/img/logo_only.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="height: 100%; margin-top: 0.1em;">
        <span class="brand-text font-weight-light"><img src="<?=url('/')?>/public/assets/img/logo_text_white.png" style="width: 5em;"></span>
      </a>
        ...
        <nav class="mt-2">
          ...
          <!-- Add icons to the links using the .nav-icon class
           ...
           <li class="nav-item" class="">
            <a href="<?=url('/')?>/dashboard" class="@if (Request::segment(1) == 'dashboard') active @endif nav-link">
          ...
          <li class="nav-item">
            <a href="<?=url('/')?>/operator" class="nav-link @if (Request::segment(1) == 'operator') active @endif">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Operator
              </p>
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link @if (Request::segment(1) == 'rekap-absen') active @endif">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Absen
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=url('/')?>/generate-absen" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=url('/')?>/rekap-absen" class="nav-link @if (Request::segment(1) == 'rekap-absen') active @endif">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Rekap Absen</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link @if ((Request::segment(1) == 'surat_masuk') || (Request::segment(1) == 'surat_keluar')) active @endif">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Surat
                <i class="right fas fa-angle-left"></i>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=url('/')?>/surat_masuk" class="@if (Request::segment(1) == 'surat_masuk') active @endif nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Surat Masuk</p>
                </a>
              </li>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=url('/')?>/surat_keluar" class="@if (Request::segment(1) == 'surat_keluar') active @endif nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Surat Keluar</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="<?=url('/')?>/surat-tugas" class="nav-link @if (Request::segment(1) == 'surat-tugas') active @endif">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Surat Tugas
              </p>
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="@if (Request::segment(1) == 'surat-izin') active @endif nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Surat Izin
                <i class="right fas fa-angle-left"></i>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=url('/')?>/surat-izin/sakit" class="@if (Request::segment(2) == 'sakit') active @endif nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Sakit</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=url('/')?>/surat-izin/izin" class="@if (Request::segment(2) == 'izin') active @endif nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Izin</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=url('/')?>/surat-izin/cuti" class="@if (Request::segment(2) == 'cuti') active @endif nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Cuti</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="<?=url('/')?>/surat-wfh" class="nav-link @if (Request::segment(1) == 'surat-wfh') active @endif">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Surat WFH
              </p>
