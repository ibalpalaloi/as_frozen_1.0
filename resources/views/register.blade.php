...
<body>
  ...
  <section class="login-content">
    <div class="login-box" style="min-height: 480px;">
      ...
      <form class="login-form" action="<?=url('/')?>/keranjang" style="margin-top: 1.5em;">
        ...
        <div class="form-group btn-container">
          <button class="btn btn-primary btn-block" style="background:#ec1f25; border: 2px solid  #ec1f25;"><i class="fa fa-sign-in fa-lg fa-fw"></i>Daftar</button>
          <div class="form-group">
            <div class="utility">
